...
import QuoteNavigationPrevious from './QuoteNavigationPrevious';
import QuoteNavigationNext from './QuoteNavigationNext';
    ...
    return (
      <div>
        <div className='quote-container'>
          ...
          <QuoteNavigationPrevious otherQuoteId={previousQuoteId} />
          <QuoteText quote={quote} />
          <QuoteNavigationNext otherQuoteId={nextQuoteId} />
        </div>
